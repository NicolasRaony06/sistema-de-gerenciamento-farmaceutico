...
g = farmacia._registrarGerente("Chico",'122.222.222-23','1-1-1998',100)
fun1 = g.cadrastar_funcionario("Alvim","123.123.123-23",'1-1-1998',890)
fun2 = g.cadrastar_funcionario("LULU","123.321.123-32",'9-2-1990',22)
